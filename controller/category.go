...
func GetCategoryByID(respw http.ResponseWriter, r *http.Request) {
...
func UpdateCategory(respw http.ResponseWriter, r *http.Request){
	...
	namaCategory := r.FormValue("name_category")
